...
class Resume extends Component {
  ...
  render() {
    const emailBody =
      "You may view Jack Tawil's resume at https://tawil.dev/resume and can reach him at jackmt9@gmail.com.";
    ...
    return (
      <div className="resume">
        <a
          className="button"
          href={pdf}
          download={`Jack_Tawil_Resume_${this.getDate()}_UTC`}
        >
          Download PDF&nbsp;&nbsp;
        ...
        <button className="button" onClick={this.toggleMarkdown}>
          {this.state.markdown ? "View PDF" : "View Markdown"}
        </button>
        {this.state.markdown ? (
          <div className="gist">
